package id.ac.poliban.aulia.sqlitedemos01.adapter;
...
import id.ac.poliban.aulia.sqlitedemos01.DetailActivity;
import id.ac.poliban.aulia.sqlitedemos01.R;
import id.ac.poliban.aulia.sqlitedemos01.dao.impl.FriendDaoimplSQLite;
import id.ac.poliban.aulia.sqlitedemos01.domain.Friend;
...
public class FriendAdapter extends RecyclerView.Adapter<FriendAdapter.FriendViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FriendViewHolder holder, int position) {
        ...
        Glide.with(holder.itemView.getContext())
                ...
                .into((ImageView) holder.imgPhoto);
